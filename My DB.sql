...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 17, 2023 at 07:11 AM
...
INSERT INTO `examination_status` (`id`, `applicant_name`, `email`, `contact`, `applied_job`, `resume_file`, `status`) VALUES
(283, 'rey angelo talap', 'reyangelotalap23@gmail.com', '091325587854', 'fsherdfsdfdsd', '', 'passed'),
(287, 'rey angelo talap', 'reyangelotalap23@gmail.com', '0916846346', 'fsherdfsdfdsd', '', 'failed'),
(288, 'rey angelo talap', 'reyangelotalap23@gmail.com', '0916846346', 'fsherdfsdfdsd', '', 'passed'),
(290, 'rey angelo talap', 'reyangelotalap23@gmail.com', '0916846346', 'fsherdfsdfdsd', '', 'passed'),
(291, 'rey angelo talap', 'reyangelotalap23@gmail.com', '0916846346', 'fsherdfsdfdsd', '', 'failed');
...
(124, 'fsherdfsdfdsd', '<p>ewqeqwewqewqewqe</p>\r\n', 'qwewqewqewqeqw', 'Rey angelo talap', '99k', 'romer@gmail.com', '9958737094', 'ewe', 'h.jpg', 0, '2023-03-14'),
(131, 'www', '<p>wejbvoafnfdjk</p>\r\n', 'dfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 'Flores, James russel', 'HUNDRED k', 'arjohnpalermo7@gmail.com', '09517520778', 'Caloocan city', '328399531_1683850058715300_688612813214891957_n.jpg', 0, '2023-03-16'),
(132, 'www', '<p>wejbvoafnfdjk</p>\r\n', 'dfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 'Flores, James russel', 'HUNDRED k', 'arjohnpalermo7@gmail.com', '09517520778', 'Caloocan city', '328399531_1683850058715300_688612813214891957_n.jpg', 0, '2023-03-16'),
(133, 'www', '<p>wejbvoafnfdjk</p>\r\n', 'dfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 'Flores, James russel', 'HUNDRED k', 'arjohnpalermo7@gmail.com', '09517520778', 'Caloocan city', '328399531_1683850058715300_688612813214891957_n.jpg', 0, '2023-03-16'),
(134, 'www', '<p>wejbvoafnfdjk</p>\r\n', 'dfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 'Flores, James russel', 'HUNDRED k', 'arjohnpalermo7@gmail.com', '09517520778', 'Caloocan city', '328399531_1683850058715300_688612813214891957_n.jpg', 0, '2023-03-16');
...
INSERT INTO `newlyhiredstatus_tbl` (`id`, `applicant_name`, `applied_job`, `status`, `email`) VALUES
(275, 'arjhon', 'fsherdfsdfdsd', '', ''),
(282, 'kenneth garcia', 'fsherdfsdfdsd', '', '');
...
--
-- Dumping data for table `passed_tbl`
--

INSERT INTO `passed_tbl` (`id`, `applicant_name`, `email`, `contact`, `applied_job`, `resume_file`, `date`, `status`) VALUES
(289, 'rey angelo talap', 'reyangelotalap23@gmail.com', '9999999999', 'fsherdfsdfdsd', 'Ivan resume.pdf', '', 'passed'),
(292, 'Test', 'test@gmail.com', '9999999999', 'fsherdfsdfdsd', 'Ivan Carlo Talap_Resume.pdf', '', 'passed'),
(293, 'rey angelo talap', 'reyangelotalap23@gmail.com', '9999999999', 'fsherdfsdfdsd', 'Ivan Carlo Talap_Resume.pdf', '', 'passed');
...
(46, 2147483647, 'Romer', 'Calisan', 'admin', 'romer@gmail.com', '$2y$10$VNZf0btwgm2v49c7k1wFwO9cANdZnKZeKUeK66BmCmYtXxbZ8E/ia', ''),
(47, 2147483647, 'rey angelo', 'talap', 'admin', 'test@gmail.com', '$2y$10$VQiWP4hBp.RdL1z/vXrfLuqN1WaPEEQZedNaWfgwsnTqgJahPF/WC', ''),
(48, 2147483647, 'rey angelo', 'talap', 'admin', 'reyangelotalap23@gmail.com', '$2y$10$5EEw3msseLzsgpEh.gObr.g.9D0MzDkutugckzzTz9QTyPLDvhKl6', ''),
(49, 2147483647, 'rey angelo', 'talap', 'RCalisan', 'qwerty@gmail.com', '$2y$10$53.maP2AxaG62HwLbpNX0u7c9eCgD5olnnVqBcSCRZyaWw2hbpkbi', ''),
(50, 2147483647, 'rey angelo', 'talap', 'admin', 'RGBCmicrofinance@gmail.com', '$2y$10$Pp3JJmsLdZiaO6fEYzPD9uDLD3fDE.wGC55dH9Bs.ckhU48w7dcPS', ''),
(51, 94489914, 'Ariane', 'Balomaga', 'JamesPhilip', 'saberonmarkanthony46@gmail.com', '$2y$10$fV7JBjhuPjVkYam9eXB3/Orq01apx/7yF2hfx0htv.MzTMDWxH/hS', '');
