...
<section id="interface">
  ...
  <div class="container contact-form">
    ...
    <i class="far fa-caret-square-down" onclick="show_hide()" id="hide" style="margin-left: 49rem;" data-toggle="tooltip" data-placement="top" title="Hide Email Configuration"></i>
  </h1>
    <hr>
    ...
    <div class="row">
      ...
      <div class="col-md-5">
        <div class="form-group">
          ...
          <input required type="text" placeholder="page name"  class="form-control" name="Email" id="email">
        </div>
