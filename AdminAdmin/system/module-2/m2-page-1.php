...
<head>
  ...
  <!-- OWN STYLE -->
  <link rel="stylesheet" href="../module-2/module-2-css/m2-page-1.css">
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" style="color: black; font-weight: 700">Examinee</li>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?php  
                ...
                $query ="SELECT * FROM  examination_tbl WHERE status IN ('examination');";  
      ...
      <td style="color: #fca103;  font-weight: 700; text-transform: uppercase"><?php echo $row['status']?></td>
        ...
        <td class="text-center">
              ...
              <button class="btn btn-outline btn-sm rounded-55" type="button" data-toggle="modal"
                ...
                style="border: 1px solid #007bff;  color: #007bff !important; background-color:transparent ! important"><i class="fas fa-envelope"></i></button>
              ...
              <li class="list-inline-item">
              <a href="../module-2/m2-page-4?id=<?php echo $row['id']?>">
              <button class="btn btn-outline btn-sm rounded-55" type="button" data-toggle="modal"
                data-placement="top" title="Send exam" data-target="#myModal"
        ...
        <td style="text-transform:uppercase"><ul class="list-inline m-0">
                        ...
                        <li class="list-inline-item">
                            ...
                            <button class="btn btn-outline btn-sm rounded-55 name" type="button" data-bs-toggle="modal"
                              data-placement="top" title="View"data-bs-target="#statusModal" style="border: 1px solid #007bff;  color: #007bff !important; background-color:transparent ! important"><i class="fas fa-exchange"  ><small style="font-size: 15px; padding: 1rem; font-family: poppins; text-transform:uppercase; font-weight: bold" >Status</small></i></button>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Examinee</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <?php
                $query = "SELECT *
                 FROM examination_tbl ";
                $result = mysqli_query($connection, $query);
                if (mysqli_num_rows($result)) {
                    $row = mysqli_fetch_assoc($result)
                ?>
              <form action="../dashboard/statusExam" method="POST">
                <input type="text" name="s_id" id="s_id" value="<?php echo $row["id"]; ?>">
               ...
               <div class="col-auto">
                <br>
                  <label for="score">Please input the total score</label>
