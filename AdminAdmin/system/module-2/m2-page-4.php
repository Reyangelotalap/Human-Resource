                ...
                <form action="../dashboard/mailExam.php?id=<?php echo $id; ?>" method="POST" id="contact-form" class="contact-form">
                    ...
                    <input type="hidden" value="<?php echo $row["id"]; ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="subject" autocomplete="on" id="Name"
                                        placeholder="Subject" value="Appreciation Letter">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea name="Message" id="editor1" rows="30" cols="80" type="text"><p style="text-align:justify; line-height: 2rem">Dear <b><?php echo $row["applicant_name"]; ?></b> ,
...
Thank you for your interest in our Organization. As part of our application process, we require all candidates to complete an online examination.

To access the examination, please click on the following link: [     ]. <br>This link will take you to the exam platform, where you will be prompted to enter your credentials.

Please note that the exam must be completed within [ ]. Once you have completed the exam, please let us know, <br> and we will review your results and be in touch with you shortly.

Thank you for your time and effort in completing this exam. <br>  <br>If you have any questions or concerns, please don't hesitate to reach out to us.
...
<b>RGBC Lending Investor Company.</b>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary pull-right" name="submit" style="font-family: poppins; font-weight: 700">Send a message</button>
                                </div>
                            </div>
                    </form>
                </div>
