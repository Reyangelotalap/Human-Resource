...
include('../../crud/connection.php');
  ...
  if (isset($_SESSION['username'], $_SESSION['password'])) {
    ...
    if(isset($_GET["id"]) && !empty(trim($_GET["id"]))){
        ...
        $sql = "SELECT * FROM initial_interview WHERE id = ?";
...
?>
    ...
    <main class="main">
        ...
        <section>
                ...
                <form action="../dashboard/Mail.php?id=<?php echo $id; ?>" method="POST" id="contact-form" class="contact-form">
                    ...
                    <input type="hidden" value="<?php echo $row["id"]; ?>">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea name="Message" id="editor1" rows="10" cols="80" type="text">
                                      </textarea>
                                    <script>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary pull-right" name="submit">Send a message</button>
                                </div>
                            </div>
                    </form>
                </div>
