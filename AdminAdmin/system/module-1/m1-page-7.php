...
<head>
  ...
  <title>Top Candidates | RGBC</title>
...
?>
        ...
        <h1 style="color: black; font-weight: 700" >Applicant Management</h1>
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" style="color: black; font-weight: 700">Top Candidates</li>
  ...
  <?php unset($_SESSION['success']); }?>
    ...
    <div class="col-md-15">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?php  
                ...
                $query ="SELECT * FROM  `newlyhired_tbl`";  
            ...
            <table id="table_id" class="table table-bordered" style="width:100%; ">
              <thead height="70px">
                <tr style="background-color: #007bff; color: #fff; font-weight: normal; text-transform: uppercase"
                  ...
                  <th>Job Applied</th>
                  <th>Email</th>
                  <th>initial Interview Ratings</th>
                  <th>Final Interview Ratings</th>
                  <th>Total Ratings</th>
                  <th>Percentage</th>
                  <th>Manage</th>
      ...
      {  
        $id = $row['id'];
       $fetchratings = "SELECT * FROM initialratings WHERE applicant_id = '$id'";
       $fetchratingsResult =  mysqli_query($connect, $fetchratings);
       $fetchratingsRow = mysqli_fetch_assoc($fetchratingsResult);
   ...
   ?>
                ...
                <tr class="text-center">
                  ...
                  <td><?php echo $fetchratingsRow['initial_ratings'] ?? ""?></td>
                  <td><?php echo $fetchratingsRow['final_ratings'] ?? ""?></td>
                  <td><?php echo $fetchratingsRow['total_ratings'] ?? ""?></td>
                  <?php if($fetchratingsRow['percentage'] >= 60){?>
                  <td class="text-success"><?php echo $fetchratingsRow['percentage'] ?? ""?>%</td>
                  <?php } elseif($fetchratingsRow['percentage'] <= 59)  {?>
                  <td class="text-danger"><?php echo $fetchratingsRow['percentage'] ?? " "?>%</td>
                  <?php }?>
