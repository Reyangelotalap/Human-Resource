...
<head>
    ...
    <title>Applicant List | RGBC </title>
    ...
    <main class="main">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item " style="color: black; font-weight: 700">Applicant List</li>
                    </ol>
                </nav>
            </div>
        </header>
        ...
        ?>
                        ...
                        <table id="table_id" class="table table-bordered" style="width:100%; ">
                            <thead height="40px">
                                <tr style="background-color: #007bff; color: #fff; text-transform: "  class="text-center">
                ...
                <!-- <td><input type="checkbox" name=""></td> -->
                 ...
                 <td><?php echo $row['upload_date']?></td>
                        ...
                        <td> 
                            ...
                            <a href="../dashboard/viewPdf?id=<?php echo $row["id"]; ?>">
                              ...
                              <li class="list-inline-item">
                              <a href="../dashboard/delApplicant?id=<?php echo $row["id"]; ?>">
                            ...
                            <li class="list-inline-item">
                            <a href="../dashboard/update?id=<?php echo $row["id"]; ?>">
                            <button class="btn btn-outline btn-sm rounded-55" type="button" data-toggle="modal" data-placement="top"
                            title="Update" data-target="" style="border: 1px solid #007bff; color: #007bff !important; background-color:transparent ! important"><i class="fas fa-pencil"></i></button>
                            </a>
                            </li>
                        ...
                        <li class="list-inline-item">
                            ...
                            <button class="btn btn-outline btn-sm rounded-55 name" type="button"  data-target="#statusModal"
                                    title="Manage" style="border: 1px solid #007bff;  color: #007bff !important; background-color:transparent ! important">
                              <i class="fas fa-exchange"  ><small style="font-size: 15px; padding: 1rem; font-family: poppins; text-transform:uppercase; font-weight: bold" >Status</small></i>
                            </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class='modal-title' id='myModalLabel' style="color: black; font-weight: 700">Changing Status</h5>
    ...
    <div class="modal-content">
      ...
      <?php
                $query = "SELECT applicant.*,resume.*
                 FROM applicant_resume resume,regapplicant applicant
                  WHERE applicant.id=resume.reg_id  ";
                ...
                ?>
                        <form action="../dashboard/status" method="POST">
                            ...
                            <select class="form-select" name="status" aria-label="Default select example">
                                ...
                                <option value="passed" name="passed" style="color: black; font-weight: 700">Passed</option>
                                <option value="failed" name="failed" style="color: black; font-weight: 700">Failed</option>
                            </select>
                            <br>
                            <br>
...
?>
                            ...
                            <br>
                            <table id="table_rejected" class="table table-bordered" style="width:100%; ">
                                <thead height="40px">
                                    <tr
                                        style="background-color: #007bff; color: #fff; font-weight: normal; text-transform: "class="text-center" >
...
<!-- <td><input type="checkbox" name=""></td> -->
        ...
        <td>
              ...
              <li class="list-inline-item">
              <a href="../dashboard/deleteRejected?id=<?php echo $row['id']?>">
              <button class="btn btn-outline btn-sm rounded-55" type="button" data-toggle="modal" data-placement="top"
                title="Delete" data-target="#delete-confirm" style="border: 1px solid red; color: red !important; background-color:transparent !important "><i class="fas fa-trash"></i></button>
            </a>
              </li>
