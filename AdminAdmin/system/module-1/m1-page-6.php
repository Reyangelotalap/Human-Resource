...
<head>
    ...
    <title>Final Inteview | RGBC</title>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" style="color: black; font-weight: 700">Final Interview</li>
                    </ol>
                </nav>
            </div>
        </header>
...
<br>
        ...
        <section style="padding: 20px">
            ...
            <div class="col-md-15">
                ...
                $query ="SELECT * FROM  `finalnterview_tbl` WHERE status IN ('Final Interview');";  
   ...
   ?>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td style="color: green; font-weight: 700; text-transform: uppercase; font-size: 17px"><?php echo $row['status']?></td>
                                    ...
                                    <td>
                                        ...
                                        <ul class="list-inline m-0">
                                            ...
                                            <li class="list-inline-item">
                                                <button class="btn btn-outline btn-sm rounded-55" type="button"
                                                    data-toggle="modal" data-placement="top" title="View"
                                                    data-target="#"
                                    ...
                                    <td style="text-transform:uppercase">
                                        <ul class="list-inline m-0">
                                            <li class="list-inline-item">
                                                ...
                                                <button class="btn btn-outline btn-sm rounded-55 name" type="button"
                                                    data-bs-toggle="modal" data-placement="top" title="View"
                                                    data-bs-target="#statusModal"
                                                    style="border: 1px solid #007bff;  color: #007bff !important; background-color:transparent ! important">
                                                    <i class="fas fa-exchange">
                                                        <small
                                                            style="font-size: 15px; padding: 1rem; font-family: poppins; text-transform:uppercase; font-weight: bold">Status</small>
                                                    </i>
                                                </button>
                                                <?php else: ?>
                                                <button class="btn btn-outline btn-sm rounded-55 name" type="button"
        ...
        <div class="modal-content">
            ...
            <div class="modal fade" id="statusModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Final Interview</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <?php
                $query = "SELECT *
                 FROM finalnterview_tbl ";
                $result = mysqli_query($connection, $query);
                if (mysqli_num_rows($result)) {
                    $row = mysqli_fetch_assoc($result)
                ?>
                            <form action="../dashboard/newlyStatus" method="POST">
                                <input type="text" name="r_id" id="r_id" value="<?php echo $row["id"]; ?>">
                                <input type="hidden" name="applicant_name" id="applicant_name" value="<?php echo $row["applicant_name"]; ?>">
                                ...
                                <select class="form-select" name="status" aria-label="Default select example">
                                    ...
                                    <option value="passed" name="passed" style="color: black; font-weight: 700">Passed
                                    </option>
                            ...
                            <br><br>
                                <div class="col-auto">
                                    <label for="ratings">Please Rate this Applicant <br> (1=Lowest, 5=Highest)</label>   
            ...
            <div class="col-md-15">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php  
                $connect = mysqli_connect("localhost", "root", "", "human_resource 1");  
                $query ="SELECT * FROM  `finalfailed_tbl` ";  
                $result = mysqli_query($connect, $query);  
                ?>

                        <br>
                        <table id="table_idfailed" class="table table-bordered" style="width:100%; ">
                            <thead height="40px">
                                <tr style="background-color: #007bff; color: #fff; font-weight: normal; "
                                    class="text-center">
