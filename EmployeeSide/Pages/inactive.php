...
<head>
  ...
  <!-- css file -->
  <link rel="stylesheet" href="../Css/inactivejob.css">
...
<body>
  ...
  <main>
        ...
        <h2 style="text-transform: uppercase;">InActive Job</h2>
            ...
            <div class="card-new">
              <div class="card-content-new">
                <div class="icon-box-new">
                  <img src="../Image/pngegg.png" alt="" style="height: 10rem; ">
                </div>
                <br>
                <div class="">
                  <p class="corp">alegariocure.corp</p>
