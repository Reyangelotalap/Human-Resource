...
function menuBtnChange() {
 if(sidebar.classList.contains("open")){
  ...
  <!-- content -->
  <header class="header" style="background-color: #0d6efd">
    <div class="header__container">
      

   <a href="#" class="header__logo" style="color:#F6C53F !important;">Hello <?php echo htmlspecialchars($_SESSION["username"]); ?></a>
  ...
  <h2 style="text-transform: uppercase; margin-left:9%;">RGBC | ESS PORTAL</h2> 
          ...
          <div class="cards-new">
            ...
            <a href="../Pages/profile.php">
              <div class="card-content-new">
                ...
                <i class='bx bx-user' style="font-size: 10em;"></i>
                </div>
                <br>
                <div class="">
                  <p class="corp">User Profile</p>
            ...
            <a href="../Pages/timeandattendance.php">
              <div class="card-content-new">
                <div class="icon-box-new">
                <i class='bx bx-time' style="font-size: 10em;"></i>
                </div>
                <br>
                <div class="">
                  <p class="corp">Time And</p>
                  <p class="position">Attendance</p>
                </div>
              </div></a>
            </div>
            <div class="card-new">
              ...
              <div class="card-content-new">
                <div class="icon-box-new">
                <i class='bx bx-pie-chart-alt-2' style="font-size: 10em;"></i>
                </div>
                <br>
                <div class="">
                  <p class="corp">Performance</p>
                  <oftware class="position"></p>
                </div>
              </div></a>
            </div>
            <div class="card-new">
              ...
              <div class="card-content-new">
                <div class="icon-box-new">
                <i class='fas fa-credit-card' style="font-size: 10em;"></i>
                </div>
                <br>
                <div class="">
                  <p class="corp">Payroll Slip</p>
                  <p class="position">Record</p>
                </div>
              </div></a>
            </div>
          </div>
