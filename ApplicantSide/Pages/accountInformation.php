...
<head>
  ...
  <title>Account Information | RGBC </title>
...
<div class="container-xl px-4 mt-4">
    ...
    <a class="nav-link " href="../Pages/editProfile">Profile</a>
    <a class="nav-link active ms-0" href="../Pages/accountInformation">Account Information</a>
        <a class="nav-link" href="../Pages/changePassword">Change Password</a>
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="inputUsername" type="text" placeholder="Enter your username" ></input>
                        </div>
                        <!-- Form Row-->
